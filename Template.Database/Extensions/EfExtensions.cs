...
namespace Template.Database.Extensions
{
    public static class EfExtensions
    {
        public static IQueryable<TEntity> IncludeAllRecursively<TEntity>(this IQueryable<TEntity> queryable, int maxDepth = int.MaxValue, bool addSeenTypesToIgnoreList = true, HashSet<Type>? ignoreTypes = null) where TEntity : class
        {
            ...
            {
                if (include.EndsWith("Id") || include.EndsWith("CreatedDate") || include.EndsWith("CreatedBy") || include.EndsWith("UpdatedDate") || include.EndsWith("UpdatedBy")) continue;
        ...
        private static void GetIncludeTypes(ref List<string> includes, string prefix, Type type, ref HashSet<Type> ignoreSubTypes, bool addSeenTypesToIgnoreList = true, int maxDepth = int.MaxValue)
        {
